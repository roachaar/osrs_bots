...
def main():
    ...
    for i in range(350):
        ...
        rsMoveTo(1228,388,0.3,2) # bank
        sleep(randint(234,1876)/10000)
        pag.click()
        sleep(4 + randint(5234,6576)/10000)
        ...
        rsMoveTo(1326,743,0.3,2) # bank
        sleep(randint(234,1876)/10000)
        pag.click()
        sleep(3.5 + randint(8234,12276)/10000)
        rsMoveTo(1231,342,0.3,2) # bank
        sleep(randint(234,1876)/10000)
        pag.click()
        sleep(27*3 + randint(8234,12276)/10000)
